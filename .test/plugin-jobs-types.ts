//! not tested
import type { JsonStructure, PluginJobs } from "@evoo/core";
import type goodbyePlugin from "@evoo/plugin-goodbye";
import type placeholderPlugin from "@evoo/plugin-placeholder";
